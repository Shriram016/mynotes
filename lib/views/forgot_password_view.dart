...
import 'package:flutter_project/utilities/dialogs/password_reset_sent_email_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  'IF you forgot your password, Enter the email Id and will send you a link'),
              TextField(
